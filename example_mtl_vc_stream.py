...
language_id = "ru"
ref_path = "ref/ref.wav"

text = "Решения о развитии территорий города принимаются с учетом информации о состоянии зеленых насаждений. Аварийные и сухостойные деревья представляют прямую угрозу. "

# Original non-streaming generation
print("Generating audio (non-streaming)...")
wav = None
try:
    wav = model.generate(text=text, language_id=language_id, audio_prompt_path=ref_path)
